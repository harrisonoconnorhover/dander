...
- Published source-free private RC22 index `sha256:ce395d…47c3` and recorded its next PostgreSQL scale objectives; public RC20 remains unchanged.
...
- Run the recorded exact-RC22 PostgreSQL scale slice, then the remaining Kubernetes scale/soak gates.
...
- `docs/evidence/phase8/2026-08-14/postgresql-bounded-memory-objectives.json`
