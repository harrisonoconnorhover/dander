...
- Recorded the `not_evaluated` AWS attempt, reopened DANDER-202 honestly, and added a packaged experimental AWS-native operator runbook.
...
- Restore Azure/OCI credentials; finish the remaining profile operator docs and freeze honest compatibility/limitations.
