...
| BigQuery | Redshift | experimental | Local IAM/S3 `COPY`, SCD1 replay, and destination-fence conformance |
...
| PostgreSQL | Redshift | experimental | Local IAM/S3 `COPY`, SCD1 replay, and destination-fence conformance |
