...
| Connector plugins | Live-proven | Exact-pinned Salesforce `0.3.1rc1` and ServiceNow `0.2.2rc1` packages install source-free with Dander `0.7.0rc2`, register through API v1, and expose presentation-safe discovery plus optional reads | The built-in Salesforce fallback is deprecated; no marketplace service or provider write-back |
...
| Orchestration/state | Live-proven | Four independent daily schedules, one paused graph schedule, leases, fencing tokens, cursor compare-and-set, staging cleanup, and exact-job failure alerts | Schedule-miss and freshness SLOs are not implemented |
...
| Release evidence | Live-proven | Public source-free Dander and plugin installs, disposable provider/GCP acceptance, retained-project runs, protected CI, and clean Terraform reconciliation | The 30-day operator soak remains open through 2026-09-01 |
