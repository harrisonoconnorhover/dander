...
WHEEL_REQUIRED = {
    ...
    "dander/templates/project/connectors/phase8_aws_fixture.yaml",
    ...
    "dander/templates/project/infra/local/Caddyfile",
    "dander/templates/project/infra/local/README.md",
    "dander/templates/project/infra/local/compose.yaml",
    "dander/templates/project/infra/local/local-control-plane.example.json",
    "dander/templates/project/infra/local/localhost-openssl.cnf",
    ...
    "dander/templates/project/models/staging/stg_phase8_aws__posts.sql",
    "dander/templates/project/models/staging/stg_phase8_aws__posts.yml",
...
SDIST_REQUIRED = {
    ...
    "infra/local/local-control-plane.example.json",
    "infra/local/localhost-openssl.cnf",
    "pyproject.toml",
