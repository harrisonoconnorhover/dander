...
deployment reads, tagged-role refresh, and pre-delete instance-profile check; those reads are
limited to D7 service, deployment, and role ARNs. Bucket and log-tag reads remain scoped to
disposable D7 resource names; the provider does not receive wildcard service-read authority.
