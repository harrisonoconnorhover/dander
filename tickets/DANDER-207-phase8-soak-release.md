...
The retained GCP operator trial concluded after its 2026-08-02 through 2026-09-01 observation
window. Its ServiceNow PDI became unavailable, and other canonical profiles have not completed an
exact-candidate scheduled soak.

## Acceptance Criteria

- [ ] Every approved profile completes its reviewed scheduled candidate soak with visible failures,
  cleanup, and no drift.
- [x] The retained GCP trial meets its 30-day and final seven-clean-day criteria after diagnostics.
...
- The final seven-day window completed with 21 of 21 enabled scheduled executions successful.
  The planned HubSpot rerun succeeded with duplicate-free output. After the window, the 2026-09-02
  Salesforce schedule hit BigQuery transaction contention and its transform task timed out; one
  documented manual recovery succeeded without contention. Final reconciliation paused all five
  retained schedules and reported no Terraform drift. This closes only the retained GCP criterion;
  the ticket and broader Phase 8 support qualification remain open.
