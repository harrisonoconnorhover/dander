...
- AWS access was restored later on 2026-08-14. The exact RC22 objective manifest and bounded USD 3
  ...
  empty inventory are recorded. Private RC27 packages the reviewed runtime-overlay, Fargate
  identity, explicit Redshift staging-role grant, and Serverless startup corrections and passes
  candidate inspection, but no pairwise live result or support status is claimed.
